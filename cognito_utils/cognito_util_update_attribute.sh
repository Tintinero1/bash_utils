...
echo -e "${GREEN}Enter yout new COGNITO ATTRIBUTE VALUE: ${NC}"
read COGNITO_ATTRIBUTE_VALUE

aws cognito-idp admin-update-user-attributes \
    --user-pool-id $USER_POOL_ID \
    --username $USERNAME \
    --user-attributes Name=$COGNITO_ATTRIBUTE_NAME,Value=$COGNITO_ATTRIBUTE_VALUE "$PROFILE_PARAM" "$PROFILE_NAME"
